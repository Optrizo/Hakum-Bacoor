...
async function checkAirtableStructure() {
  try {
    ...
    // Since we can't use fetch directly in this environment, we'll use another approach
    console.log('Please check your Airtable table structure manually by:');
    console.log('1. Go to https://airtable.com/');
    console.log(`2. Open your base (${process.env.VITE_AIRTABLE_BASE_ID})`);
    console.log(`3. Open the table "${process.env.VITE_AIRTABLE_TABLE_NAME}"`);
