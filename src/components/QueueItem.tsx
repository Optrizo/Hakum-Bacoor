        ...
        <div className="flex items-start justify-between">
            <div className="flex-grow min-w-0">
                <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-1">
                    <div className="flex-shrink-0 bg-brand-blue text-white font-bold text-sm sm:text-base px-2 sm:px-3 py-1 rounded-md">
                        {car.plate}
                    </div>
                    <span className="text-base sm:text-lg font-medium text-text-primary-light dark:text-text-primary-dark truncate">{car.model}</span>
                </div>
          ...
          <div className="mt-4 pt-4 border-t border-border-light dark:border-border-dark">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 text-sm">
              ...
              <div>
                ...
                <p className="text-base sm:text-lg font-bold text-green-500 dark:text-green-400">₱{(car.total_cost || 0).toLocaleString()}</p>
              </div>
              <div>
            ...
            {isAssigningCrew && (
              <div className="mb-4 p-3 sm:p-4 bg-background-light dark:bg-black/50 rounded-lg border border-border-light dark:border-border-dark">
            ...
            <div className="flex flex-col gap-4 mt-4 border-t border-border-light dark:border-border-dark pt-4">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  ...
                  {car.status === 'in-progress' && (
                    <button
                      ...
                      disabled={isUpdating}
                      className="inline-flex items-center justify-center px-4 py-2.5 sm:py-2 rounded-lg text-sm font-semibold bg-yellow-500 text-white hover:bg-yellow-600 transition-all duration-200 disabled:opacity-50 transform hover:scale-105 active:scale-95"
                    >
                  ...
                  {car.status === 'payment-pending' && (
                    <button
                      ...
                      disabled={isUpdating}
                      className="inline-flex items-center justify-center px-4 py-2.5 sm:py-2 rounded-lg text-sm font-semibold bg-green-500 text-white hover:bg-green-600 transition-all duration-200 disabled:opacity-50 transform hover:scale-105 active:scale-95"
                    >
              ...
              <div className="flex flex-wrap gap-2 justify-end">
                <button
                  ...
                  className={`inline-flex items-center p-2 border shadow-sm text-xs font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue transition-colors ${
                    isAssigningCrew 
